...
RSpec.describe Item, type: :model do
  ...
  before(:each) do
    ...
    @item1 = @merchant1.items.create!(name: 'Item 1', description: 'An item',
                                      unit_price: 1300, status: 0)
    @item2 = @merchant1.items.create!(name: 'Item 2',
                                      description: 'Another item', unit_price: 1200, status: 1)
    @item3 = @merchant2.items.create!(name: 'Item 3',
                                      description: 'Another other item', unit_price: 1240, status: 1)
