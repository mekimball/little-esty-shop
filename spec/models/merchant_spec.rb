...
RSpec.describe Merchant, type: :model do
  before do
      ...
      @transaction4 = Transaction.create!(credit_card_number: 230429, result: 0, invoice_id: @invoice_4.id)
      ...
      @transaction7 = Transaction.create!(credit_card_number: 203942, result: 0, invoice_id: @invoice_8.id)
