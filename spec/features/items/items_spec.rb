...
RSpec.describe 'Item index page', type: :feature do
  before(:each) do
    ...
    @item_1 = @merchant_1.items.create!(name: 'Item 1', description: 'An item',
                                        unit_price: 1300)
    @item_2 = @merchant_1.items.create!(name: 'Item 2',
                                        description: 'Another item', unit_price: 1200, status: 1)
    @item_3 = @merchant_2.items.create!(name: 'Item 3',
                                        description: 'Another other item', unit_price: 1240)
